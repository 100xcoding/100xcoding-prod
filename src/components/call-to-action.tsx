    ...
    <div className="my-32">
      <div className="text-center">
        <h1 className="text-3xl md:text-4xl font-inter font-extrabold tracking-wide text-violet-500  w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[65%] mx-auto leading-7">
          Join 200+ people building portfolio-worthy projects and unleashing
          their potential.
        </h1>
        <p className="my-12 text-lg font-poppins font-medium tracking-wide text-slate-300 w-full sm:w-[90%] md:w-[80%] lg:w-[75%] mx-auto leading-7">
