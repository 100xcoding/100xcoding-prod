  ...
  return (
    <div className="my-20 bg-gray-950 opacity-85">
      ...
      >
        <AccordionItem
          value="item-1"
          className="border border-white/[0.4] rounded-lg px-2.5 md:px-5"
        >
        ...
        <AccordionItem
          value="item-2"
          className="border border-white/[0.4] rounded-lg px-2.5 md:px-5 my-4"
        >
        ...
        >
          ...
          <AccordionContent className="text-base md:text-lg">
            You can contact our support team by clicking on the Contact Us link
            at the bottom of the page. Fill out the form with your query, and
