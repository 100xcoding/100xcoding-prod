    ...
    <section className="text-white my-10">
      <div className="space-y-6 max-w-2xl mx-auto px-4">
        ...
        <div className="">
          ...
          <p>
            Welcome to 100xCoding.com. These terms and conditions outline the
        ...
        <div className="">
          ...
          <p>
            By accessing or using 100xCoding.com, you agree to comply with and
        ...
        <div className="">
          ...
          <p>
            You must not use the website to distribute any harmful, offensive,
            or illegal content.
          </p>
        </div>
        <div className="">
        ...
        <div className="">
          ...
          <p>
            ...
            and software, is the property of 100xCoding.com or its content
            suppliers and is protected by intellectual property laws.
          </p>
          <p>
            You may not reproduce, distribute, or create derivative works from
            any content on the website without our express written permission.
          </p>
          <p>
            Certain content on the website may be available under public domain
            or other licenses that permit reuse. Such content will be clearly
            marked, and users are allowed to use it in accordance with the terms
            specified.
          </p>
          <p>
            We provide credit to all public domain sources we use by mentioning
        ...
        <div className="">
          ...
          <p>
            By submitting content to the website (e.g., comments, project
            submissions), you grant us a non-exclusive, royalty-free, perpetual,
            and worldwide license to use, reproduce, modify, and distribute your
            content in connection with the website.
          </p>
          <p>
            You represent and warrant that you own or have the necessary rights
            to the content you submit and that your content does not infringe
        ...
        <div className="">
          ...
          <p>
            ...
            warranties of any kind, express or implied, regarding the website or
            its content.
          </p>
          <p>
